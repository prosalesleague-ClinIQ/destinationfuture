...
export default function CareerPage() {
  ...
  const topTwoCareers = CAREERS.filter((c) => topTwo.includes(c.id));
  const chosenCareer = CAREERS.find((c) => c.id === chosenId) || null;
  ...
  const handleExport = () => {
    ...
    const md = `# Career Action Plan: ${c.title}
      ...
      {step === 1 && (
        <>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-white/80">Your Top 10 Career Matches</h2>
            ...
            <div className="rounded-2xl overflow-hidden mb-6">
              <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-5">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs uppercase tracking-widest text-white/60 mb-1">Your Chosen Career Path</p>
